#GEO Database Search - Team Antidepressant (EE/PA on hippocampus)
#Phoebe Vong
# 06/25/2026
...
############################### use single quotation marks for non-exact matches
...
write.csv(QueryResults, "G:/My Drive/BDA Code/QueryResults/AntidepressantPreliminary (06-25-2026).csv")

#Where outputted  file by checking identity of working directory (if no specified location)
getwd()

...
The repository contains all of the code that was used to obtain the transcriptomic data, obtain differential expressions, collapse the results per gene, correct for false discovery, and generate data visualizations.
